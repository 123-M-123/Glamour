...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const mostrarPrecios = searchParams.get('precios') !== 'no'; // 👈 Sensor de precios
    ...
    const jpgBuffer = await sharp(Buffer.from(pngBuffer)).jpeg({ quality: 80, mozjpeg: true }).toBuffer();
