export const STORE_CONFIG = {
  "glamour-urquiza": {
    ...
    tiktok: "https://www.tiktok.com/@glamour.urquiza", // Reemplazar con URL real
    ...
    politicas: {
      ...
      devoluciones: {
        ...
        cuerpo: "Según la ley vigente, tenés 10 días corridos para revocar tu compra (botón de arrepentimiento). El reintegro se realizará por el mismo medio de pago utilizado."
      },
      envios: {
